...
- [x] **v0.3.21 (LinkedIn Overhaul)**: Unified LinkedIn degree classification using standardized note markers. Replaced individual degree filters with a single tri-state sync.
